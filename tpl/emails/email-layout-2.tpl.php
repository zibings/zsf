		...
		<table id="pageContainer" width="100%" align="center" background="images/bg.jpg" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse; background-repeat:repeat; background-color:#333333;">
			<tr>
				<td style="padding:30px 20px 40px 20px;">
					...
					<!-- Start of content with icon on the left -->
					<table bgcolor="#ffffff" width="600" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse; text-align:left; font-family:Arial, Helvetica, sans-serif; font-weight:normal; font-size:12px; line-height:15pt; color:#777777;">
						<tr>
							<td width="600" colspan="2" style="padding-top:30px; padding-right:30px; padding-left:30px; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:100%; color:#aaaaaa;">
								<img alt="" src="images/categoryIcon.png" height="14" width="15" border="0" vspace="0" hspace="0" style="vertical-align:-2px;" />&nbsp;&nbsp; Latest News
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td width="110" style="padding-right:15px; padding-left:30px; padding-bottom:35px; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#777777;">
								<img alt="image" src="images/icon1.png" height="110" width="110" border="0" vspace="0" hspace="0" align="left" style="display:block;" />
							</td>
							<td width="400" valign="top" style="padding-right:30px; padding-left:15px; padding-bottom:35px; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#777777;">
								Lorem ipsum dolor sit amet, adipiscing elit. Nulla fringilla auctor sem, sit amet tristique odio dictum quis neque diam, ornare ac blandit consequat, ultrices nec justo tortor at lectus.
					...
					<!-- End of content with icon on the left -->
					...
					<table bgcolor="#ffffff" width="600" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse; text-align:left; font-family:Arial, Helvetica, sans-serif; font-weight:normal; font-size:12px; line-height:15pt; color:#777777;">
						...
						<tr>
							<td width="110" style="padding-right:15px; padding-left:30px; padding-bottom:35px; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#777777;">
								<img alt="image" src="images/icon2.png" height="110" width="110" border="0" vspace="0" hspace="0" align="left" style="display:block;" />
							</td>
							<td width="400" valign="top" style="padding-right:30px; padding-left:15px; padding-bottom:35px; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#777777;">
								Nam sollicitudin felis sed mi pellentesque quis eleifend lectus. Morbi rutrum justo in magna sodales mollis ullamcorper diam tincidunt. Nulla sollicitudin euismod consequat.
					...
					<table bgcolor="#ffffff" width="600" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse; text-align:left; font-family:Arial, Helvetica, sans-serif; font-weight:normal; font-size:12px; line-height:15pt; color:#777777;">
						<tr>
							<td width="600" colspan="2" style="padding-top:30px; padding-right:30px; padding-left:30px; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:100%; color:#aaaaaa;">
								<img alt="" src="images/categoryIcon.png" height="14" width="15" border="0" vspace="0" hspace="0" style="vertical-align:-2px;" />&nbsp;&nbsp; Blog
								&nbsp;&nbsp;<img alt="" src="images/arrowIcon.png" height="14" width="5" border="0" vspace="0" hspace="0" style="vertical-align:-2px;" />&nbsp;&nbsp; Marketing Tips
							</td>
						</tr>
						<tr>
							<td width="600" colspan="2" style="padding-right:30px; padding-left:30px; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#777777;">
						...
						<tr>
							<td width="110" style="padding-right:15px; padding-left:30px; padding-bottom:35px; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#777777;">
								<img alt="image" src="images/icon3.png" height="110" width="110" border="0" vspace="0" hspace="0" align="left" style="display:block;" />
							</td>
							<td width="400" valign="top" style="padding-right:30px; padding-left:15px; padding-bottom:35px; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#777777;">
								Sed suscipit dapibus odio, et commodo odio placerat ac mollis augue sit amet purus imperdiet adipiscing. Nunc vel augue a ante pharetra imperdiet facilisis massa non diam.
