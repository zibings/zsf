<template>
	<div class="grid">
		...
		<div class="col-12 xl:col-6">
			<Card class="card">
				<template #title> <h5>Sales Overview</h5> </template>
				<template #content>
				...
				<template #content>
					...
					<ul class="p-0 m-0 list-none">
						...
						<li class="flex align-items-center py-2 border-bottom-1 surface-border">
							...
							<span class="text-900 line-height-3">
								Jane Davis
								<span class="text-700">has posted a new question about your product.</span>
							</span>
						</li>
					</ul>
				</template>
...
<script setup>
import { lineChart } from "@/composables/chart-colors.js";
