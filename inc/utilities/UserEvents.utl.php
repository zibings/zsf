<?php
	...
	class UserEventTypes extends EnumBase {
		const int CONFIRM            = 1;
		const int CONFIRM_PRE        = 2;
		const int CREATE             = 3;
		const int CREATE_PRE         = 4;
		const int DELETE             = 5;
		const int DELETE_PRE         = 6;
		const int LOGIN              = 7;
		const int LOGIN_PRE          = 8;
		const int LOGOUT             = 9;
		const int LOGOUT_PRE         = 10;
		const int REGISTER           = 11;
		const int REGISTER_PRE       = 12;
		const int RESETPASSWORD      = 13;
		const int RESETPASSWORD_PRE  = 14;
		const int SEND_RESETPASSWORD = 15;
		const int UPDATE             = 16;
		const int UPDATE_PRE         = 17;
	}
